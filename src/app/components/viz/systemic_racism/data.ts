...
export const DETAILS: Details[] = [
	...
	year: 1915,
	body: 'Birth of the Nation was a cinematic masterpiece. It was the first movie screened at the White House, the first 12-reel film, and the first to have its own orchestral musical score. It pioneered close-ups, fade-outs, and a carefully staged battle sequence with hundreds of extras made to look like thousands. It was also a hate film that glorified the KKK, about a black people exerting undue influence on the South during Reconstruction. First, a black captain (Walter Long in blackface) from the Union army relentlessly pursuing a Confederate Colonel\'s little sister until she commits suicide, then a black member from the South Carolina (this character of Silas Lynch has no basis in fact, and during the Reconstruction no black or mulatto men served as the lieutenant governor of South Carolina) legislature coerces the governor\'s daughter with weapons to marry him, until clan members come in to restore the peace. In summary, Hollywood\'s first smashing box office success was also racist Aryan propaganda.',
	citations: [
	    {
		source: 'NPR',
