...
export const DETAILS: Details[] = [
	...
	year: 1861,
	body: 'America was so divided over slavery that we went to war with ourselves over it. The belief that a small group of rich slave owners had become so politically powerful that they could seize the national government for themselves and protect the morally abhorrent practice of slavery become a festering sore in the American consciousness. President Lincoln describes to the Republican state convention: "A house divided against itself cannot stand. I believe this government cannot endure, permanently half slave and half free. I do not expect the Union to be dissolved - I do not expect the house to fall - but I do expect it will cease to be divided. It will become all one thing, or all the other. Either the opponents of slavery, will arrest the further spread of it, and place it where the public mind shall rest in the belief that it is in course of ultimate extinction; or its advocates will push it forward till it shall become alike lawful in all the States, old as well as new-North as well as South. Have we no tendency to the latter condition?" Shortly after Abraham Lincoln had been inaugurated as the president, war broke out between the Union and Confederacy.',
	citations: [
	    {
