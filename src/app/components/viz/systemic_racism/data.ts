...
export const DETAILS: Details[] = [
	...
	citations: [
        ...
        {
	title: 'Black Wall Street gets burned down and black Americans slaughtered by KKK in Tulsa',
	year: 1921,
	body: 'By the 1920s, the African American community in Tulsa, Oklahoma emerged as a nationally renownd entrepreneurial center, with it\'s Greenwood district known as "Black Wall Street". Black educator, entrepreneur, and landowner, O.W. Gurley owned rental properties, a rooming house, a grocery store, and a hotel. J.B. Stradford, a lawyer, owned another of the area’s several hotels. Simon Berry ran a jitney, a bus line, a charter plane service, and a hotel. The Williams Family owned a theatre, a garage, a confectionery, and a rooming house. Dr A.C. Jackson, called the “most able negro surgeon in America” by the Mayo brothers of the Mayo Clinic, broke the color line, attending to black and white patients aline. This was just a sliver of the talent in this burgeoning community, abruptly ended by the thousands of armed white men, some deputized by local law enforcement, that invaded the Greenwood district and savaged Tulsa’s burgeoning black community. They gunned people down (including Dr. A.C. Jackson of the Mayo Clinic, who had his hands raised for mercy) and set fires throughout the district. Planes, likely privately owned, dropped incendiary devices on the Greenwood district. In less than 24 hours, a white mob reduced a vibrant, 35-block area to rubble and dead bodies. The vast majority of Tulsa\'s African American population had been made homeless by the event. Yet, despite efforts by the white establishment to force the relocation of the black community, within days of the violence black Tulsans had already begun the long and arduous process of rebuilding Greenwood. Thousands, however, were forced to spend the winter of 1921–22 living in tents.',
	citations: [
	    {
