...
export const DETAILS: Details[] = [
	...
	year: 1915,
	body: 'The first movie to be screened at the White House. It was the first 12-reel film ever made and, at three hours, also the longest up to that point.[8][failed verification] Its plot, part fiction and part history, chronicling the assassination of Abraham Lincoln by John Wilkes Booth and the relationship of two families in the Civil War and Reconstruction eras over the course of several years—the pro-Union (Northern) Stonemans and the pro-Confederacy (Southern) Camerons—was by far the most complex of any movie made up to that date. It was originally shown in two parts separated by another movie innovation, an intermission, and it was the first to have a musical score for an orchestra. It pioneered close-ups, fade-outs, and a carefully staged battle sequence with hundreds of extras (another first) made to look like thousands. Adapted from the book The Clansman by Thomas Dixon Jr., who was a classmate and friend of President Woodrow Wilson, The Birth of a Nation portrayed Reconstruction as catastrophic. It showed Radical Republicans encouraging equality for blacks, who in the film are represented as uncouth, intellectually inferior and predators of white women.',
	citations: [
	    {
		source: 'NPR',
